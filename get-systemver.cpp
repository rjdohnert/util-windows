...
void PrintHelp() {
    std::cout << "Usage: get-systemver [OPTION]...\n"
...
int main(int argc, char* argv[]) {
        ...
        if (arg[0] == '-' && arg[1] != '-') {
            ...
            for (size_t j = 1; j < arg.length(); ++j) {
                ...
                switch (arg[j]) {
                    ...
                    default:
                        std::cerr << "get-systemver: invalid option -- '" << arg[j] << "'\n"
                                  << "Try 'get-systemver --help' for more information.\n";
                        return 1;
                }
            }
            ...
            if (arg == "--all") {
                ...
                std::cerr << "get-systemver: unrecognized option '" << arg << "'\n"
                          << "Try 'get-systemver --help' for more information.\n";
                return 1;
            }
        } else {
            std::cerr << "get-systemver: extra operand '" << arg << "'\n"
                      << "Try 'get-systemver --help' for more information.\n";
            return 1;
        }
    }
    ...
    std::string sysname = "Microsoft Windows NT";
